<x-layout>
    ...
    <div class="max-w-screen-xl px-4 py-4 mx-auto my-4 lg:py-8 lg:px-0">
        <div class="grid gap-8 lg:grid-cols-3 md:grid-cols-2">
            @forelse ($posts as $post)
                <article
                    ...
                    <p class="mb-5 font-light text-justify text-gray-500 dark:text-gray-400">
                        {{ Str::limit($post->body, 75) }}</p>
